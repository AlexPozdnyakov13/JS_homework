...
while (isNaN(salary)) {
    ...
    salary = Number(prompt('Введите размер заработной платы'));
}
...
const Sum = (num4,num5) => num4+num5;
    
const Subtraction = (num4,num5) => {
    if (num4>num5) {
        return(num4-num5);
    } else {
        return (num5-num4);
...
const Mult = (num4,num5) => num4*num5;
    
const Division = (num4,num5) => num4/num5;
